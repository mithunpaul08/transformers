...
#--model_name_or_path bert-base-cased --task_name fevercrossdomain --do_train --do_eval --do_predict --data_dir /Users/mordor/research/huggingface/src/transformers/data/datasets/fever/fevercrossdomain/lex/figerspecific --max_seq_length 128 --per_device_eval_batch_size=16 --per_device_train_batch_size=16 --learning_rate 1e-5 --num_train_epochs 1 --output_dir output/fever/fevercrossdomain/lex/figerspecific/bert-base-cased/128/1/ --overwrite_output_dir --weight_decay 0.01 --adam_epsilon 1e-6 --overwrite_cache
