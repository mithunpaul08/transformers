...
export PYTHONPATH="/home/u11/mithunpaul/xdisk/huggingface_bert_fnc_to_fever_lex_from_stand_alone_code/code/src"
export CUDA_VISIBLE_DEVICES=0

pip install --upgrade pip

   
cd /home/u11/mithunpaul/xdisk/huggingface_bert_fnc_to_fever_lex_from_stand_alone_code/code/examples

pip install -r requirements.txt
pip install transformers
pip install wget

cd /home/u11/mithunpaul/xdisk/huggingface_bert_fnc_to_fever_lex_from_stand_alone_code/code/mithun_scripts
