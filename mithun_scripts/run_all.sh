...
if [ $MACHINE_TO_RUN_ON == "hpc" ]; then
        ...
        export OUTPUT_DIR_BASE="/home/u11/mithunpaul/xdisk/huggingface_bert_fnc_to_fever_combined_attndropout0pt25classLossWeight0pt0875/output"
        export DATA_DIR_BASE="/home/u11/mithunpaul/xdisk/huggingface_bert_fnc_to_fever_combined_attndropout0pt25classLossWeight0pt0875/data"
else
        wandb off
...
--toy_data_dir_path $TOY_DATA_DIR_PATH --overwrite_cache --attention_dropout 0.25"
