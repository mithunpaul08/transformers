...
if [ $MACHINE_TO_RUN_ON == "hpc" ]; then
        ...
        export OUTPUT_DIR_BASE="/home/u11/mithunpaul/xdisk/huggingface_bert_fnc_to_fever/output"
        export DATA_DIR_BASE="/home/u11/mithunpaul/xdisk/huggingface_bert_fnc_to_fever/data"
else
        wandb off
