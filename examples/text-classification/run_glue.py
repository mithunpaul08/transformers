...
def main():
    ...
    # save the model only at the last epoch. this caluclation gives the step count after last epoch
    # save_steps= no of steps per epoch * no of epochs= (size of data/batch size)*no of epochs
    import math
